...
function abstract_modifyfield!(interp::AbstractInterpreter, argtypes::Argtypes, sv::InferenceState)
    ...
    o = unwrapva(argtypes[2]) # TODO (lattice overhaul)
    f = unwrapva(argtypes[3]) # TODO (lattice overhaul)
    ...
    if nargs >= 5 && RT !== ⊥
        ...
        op = unwrapva(argtypes[4]) # TODO (lattice overhaul)
        v = unwrapva(argtypes[5]) # TODO (lattice overhaul)
